    ...
    <div class="flex py-3 lg:ps-8">
      ...
      <div class="flex flex-col">
       <div class="-m-1.5 overflow-x-auto">
          ...
          <!-- Header -->
        <div class="px-6 py-4 pb-10 grid gap-3 md:flex md:justify-between md:items-center border-b border-gray-200 dark:border-neutral-700">
            <div>
              ...
              <tr class="bg-white hover: dark:bg-slate-900 dark:hover:bg-slate-950">
                <td class="size-px whitespace-nowrap">
                    ...
                    <span class="block px-6 py-2">
                      <span class="font-mono text-sm text-gray-600 dark:text-neutral-400">{{ $loop->iteration }}</span>
                    </span>
                ...
                <td class="size-px whitespace-nowrap">
                    ...
                    <span class="block px-6 py-2">
                      <span class="font-mono text-sm text-gray-600 dark:text-neutral-400">{{ $jurusan->nama }}</span>
                    </span>
                  
                </td>
                <td class="size-px whitespace-nowrap">
                    <span class="block px-6 py-2">
                      <span class="text-sm text-gray-600 dark:text-neutral-400">{{ $jurusan->akreditasi }}</span>
                    </span>
                </td>
                <td class="size-px whitespace-nowrap">
                ...
                <td class="size-px whitespace-nowrap cursor-pointer">
                    <a href="/dashboard/jurusans/{{ $jurusan->id }}" class="">
                ...
                <td class="size-px whitespace-nowrap cursor-pointer">
                  <form action="/dashboard/jurusans/{{ $jurusan->id }}" action="post">
                  @method('delete')
                  @csrf
