              ...
              <div class="flex justify-center">
                ...
                <img src="/images/logo.png" alt="" class="w-full">
                    ...
                    <div class="flex space-x-10 justify-center items-center mb-14">
                        ...
                        <a href="https://www.instagram.com/baleehash_/" class="block  text-purple-600 transition-all duration-500 hover:text-indigo-600 ">
                        ...
                        <a href="https://www.facebook.com/Baleeehash?_rdc=1&_rdr" class="block  text-purple-600 transition-all duration-500 hover:text-indigo-600 ">
                        ...
                        <a href="https://www.youtube.com/watch?v=uHgt8giw1LY" class="block  text-purple-600 transition-all duration-500 hover:text-indigo-600 ">  
                    ...
                    <span class="text-lg text-gray-500 text-center block">©<a href="https://ilhanhj-portfolio-v2.vercel.app/">Cheesecool University</a> 2024, All rights reserved.</span>
            </div>
        </div>
    </footer>
