<header class="z-50 flex flex-wrap w-full md:justify-start md:flex-nowrap py-7">
    <nav class="relative flex flex-wrap items-center w-full px-4 mx-auto max-w-7xl md:grid md:grid-cols-12 basis-full md:px-6 font-normal" aria-label="Global">
      <div class="md:col-span-3">
        <!-- Logo -->
        <a class="flex-none inline-block text-xl font-normal rounded-md focus:outline-none focus:opacity-80" href="../../templates/creative-agency/index.html" aria-label="Preline">
      ...
      <div class="flex items-center py-1 gap-x-2 ms-auto md:ps-6 md:order-3 md:col-span-3">
        <a href="/login" class="">
            <button type="button" class="inline-flex items-center px-3 py-2 text-sm font-medium text-black border border-neutral-200 gap-x-2 rounded-md hover:bg-neutral-100 disabled:opacity-50 disabled:pointer-events-none dark:border-neutral-600 dark:hover:bg-white/10 dark:text-white dark:hover:text-white">
                LOGIN
            </button>   
        </a>
        <a href="/register" class="">
            <button type="button" class="inline-flex items-center px-3 py-2 text-sm font-medium text-white transition border border-transparent gap-x-2 rounded-md bg-purple-800 hover:bg-purple-500 disabled:opacity-50 disabled:pointer-events-none focus:outline-none focus:bg-purple-500">
                REGISTER
            </button>
        </a>
      ...
      <div id="navbar-collapse-with-animation" class="hidden overflow-hidden transition-all duration-300 hs-collapse basis-full grow md:block md:w-auto md:basis-auto md:order-2 md:col-span-6">
        <div class="flex flex-col mt-5 gap-y-4 gap-x-0 md:flex-row md:justify-center md:items-center md:gap-y-0 md:gap-x-7 md:mt-0">
          <div>
            <a class="inline-block font-medium focus:text-white hover:text-neutral-600 dark:text-neutral-500 dark:hover:text-neutral-300" href="#tentang" aria-current="page">TENTANG</a>
          </div>
          <div>
            <a class="inline-block font-medium focus:text-white hover:text-neutral-600 dark:text-neutral-500 dark:hover:text-neutral-300" href="#jurusan">JURUSAN</a>
          </div>
          <div>
            <a class="inline-block font-medium focus:text-white hover:text-neutral-600 dark:text-neutral-500 dark:hover:text-neutral-300" href="#whyus">WHY US</a>
          </div>
          <div>
            <a class="inline-block font-medium focus:text-white hover:text-neutral-600 dark:text-neutral-500 dark:hover:text-neutral-300" href="/team">TEAM</a>
          </div>
          <div>
            <a class="inline-block font-medium focus:text-white hover:text-neutral-600 dark:text-neutral-500 dark:hover:text-neutral-300" href="#contact">CONTACT</a>
          </div>
        </div>
      </div>
      <!-- End Collapse -->
