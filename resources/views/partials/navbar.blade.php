<header class="z-50 flex flex-wrap w-full py-7 md:justify-start md:flex-nowrap">
    <nav class="relative flex flex-wrap items-center w-full px-4 mx-auto font-normal max-w-7xl md:grid md:grid-cols-12 basis-full md:px-6" aria-label="Global">
      ...
      <div class="flex items-center py-1 gap-x-2 ms-auto md:ps-6 md:order-3 md:col-span-3">
        <div class="hs-dropdown relative inline-flex" id="navbar-gsap">
          ...
          <div class="hs-dropdown-menu transition-[opacity,margin] duration hs-dropdown-open:opacity-100 opacity-0 hidden min-w-60 bg-white shadow-md rounded-lg p-2 mt-2 dark:bg-slate-900  after:h-4 after:absolute after:-bottom-4 after:start-0 after:w-full before:h-4 before:absolute before:-top-4 before:start-0 before:w-full" aria-labelledby="hs-dropdown-default" id="navbar-gsap">
      ...
      <div class="flex items-center py-1 gap-x-2 ms-auto md:ps-6 md:order-3 md:col-span-3">
        ...
        <a href="/register" id="navbar-gsap" class="inline-flex items-center justify-center px-4 py-3 text-sm font-medium text-center text-white border border-transparent rounded-md gap-x-3 bg-gradient-to-tl from-blue-600 to-violet-600 hover:from-violet-600 hover:to-blue-600 dark:focus:ring-offset-gray-800" href="#">
          REGISTER
        </a>
